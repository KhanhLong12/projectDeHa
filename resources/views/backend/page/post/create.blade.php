			...
			<div class="modal-body">
				<form id="createFormPostID" method="post" action="{{ route('post.store') }}" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="text" name="name" value="abc" class="form-control" id="name" placeholder="Nhap ten danh muc">
					</div>
					...
					<div class="form-group">
						...
						<input type="text" name="description" value="abc" class="form-control" id="description" placeholder="Nhap mo ta">
					</div>

					<div class="form-group">
						<label for="exampleInputDes">Noi dung</label>
						<textarea class="textarea" name="content" id="content" placeholder="Place some text here"
						style="width: 100%; height: 500px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">abcaaaaaaaaaa</textarea>
					</div>
